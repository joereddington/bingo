...
"""
    for card_number in range(1, num_students + 1):
        ...
        lc += "You are now playing on hard mode: today's grid was generated by Joe's `bingo-hard' array. Nobody at all completed one of these grids last year.  "
...
if __name__ == "__main__":
    ...
    bingo_words_easy = [
        "Joe walks too far from the console", 
        "Joe doesn't know the answer to the question", 
        "Typo pointed out on slide", 
        "A student asks a question based on the slide", 
        "One student replies to another's question", 
        "Not a question, more a comment", 
        "A round of applause", 
        "A student gives an example from their own experience", 
        "The class points to a wall", 
        "A relevant link is shared in Teams", 
        "Security seems hard", 
        "Security seems like fun",  
        "Someone is late",  
        "Student requests a (non-typo) change to slide content", 
        "Attendance is more than 60", 
        "One student asks a question on behalf of another", 
        "Some information is useful but off-topic", 
        "Slide text is too small", 
        "Reference to a pop culture event before 2000", 
        "Joe can't work a computer", 
        "Class consulted on lecture structure", 
        "Someone asks a question that I am interested in", 
        "Student question contains a music lyric or film quote of more than five words", 
        "A phone goes off"
    ]


    bingo_words_medium = ["Joe walks too far from the microphone", "Joe doesn't know the answer to a relevant question", "Typo pointed out", "A student asks a question based on the reading.", "One student replies to another student's question from at least four people/rows away",
                   "Not a question more a comment", "Someone asks a question for the first time in the course", "A student gives an example from their own experience", "The class point to a wall", "A relevant link is shared in teams", "Management seems like fun",  
                   "Student requests a (none-typo) change to slide content", "Attendance is more than 90", "One student asks a question on behalf of another", "Some information is useful but off-topic", "We'll talk about this later in the course", "A definition that might be on the exam", "Reference to a pop culture event before 2000", "I personally have done the reading", "Class consulted on course (not lecture) structure"]
