...
if __name__ == "__main__":
    ...
    bingo_words = ["There are four students in the room not registered on the course", "Joe doesn't know the answer to the question", "A typo is found on a slide", "A student asks a question based on the reading.", "One student replies to another's question from at least four people/rows away",
